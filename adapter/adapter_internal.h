 ...
 *
 * Defines the opaque struct layouts used only by the adapter's `.cc` files.
 * This is not part of the public C API; include it only from `.cc` files,
 * never from a public `.h` header.
 */
